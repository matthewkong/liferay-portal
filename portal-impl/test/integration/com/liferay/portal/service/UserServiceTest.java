...
public class UserServiceTest {
	...
	public void testEmailSecurityAddUserWithWorkFlow() throws Exception {
		...
		long temp = Long.valueOf(PrincipalThreadLocal.getName());
		...
		PrincipalThreadLocal.setName(temp);
	}
	...
	protected User addUserWithWorkFlow() throws Exception {
		boolean autoPassword = true;
		String password1 = StringPool.BLANK;
		String password2 = StringPool.BLANK;
		boolean autoScreenName = true;
		...
		return UserServiceUtil.addUserWithWorkflow(
			TestPropsValues.getCompanyId(), autoPassword, password1, password2,
			autoScreenName, screenName, emailAddress, facebookId, openId,
			locale, firstName, middleName, lastName, prefixId, suffixId, male,
			birthdayMonth, birthdayDay, birthdayYear, jobTitle, groupIds,
