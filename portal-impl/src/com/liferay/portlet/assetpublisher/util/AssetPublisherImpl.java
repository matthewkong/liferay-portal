...
public class AssetPublisherImpl implements AssetPublisher {
	...
	public Object[] getAssetEntryObject(
			long companyId, boolean enablePermissions, boolean isConfiguration,
			long[] groupIds, String[] assetEntryXmls,
		...
		for (int i = 0; i < results.size(); i++) {
			...
			for (long groupId : groupIds) {
				assetEntry = AssetEntryLocalServiceUtil.
					fetchEntry(groupId, assetEntryUuid);
			...
			else if (!assetRenderer.isDisplayable() || (enablePermissions &&
