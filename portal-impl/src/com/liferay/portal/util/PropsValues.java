...
public class PropsValues {
	...
	public static final String[] FIELDS_EDITABLE_EXCEPTIONS = PropsUtil.getArray(PropsKeys.FIELDS_EDITABLE_EXCEPTIONS);

	public static final String[] FIELDS_EDITABLE_USERS = PropsUtil.getArray(PropsKeys.FIELDS_EDITABLE_USERS);
	
	public static final String[] USER_DETAILS_UPDATE_ENABLED_DOMAIN_WHITELIST = PropsUtil.getArray(PropsKeys.USER_DETAILS_UPDATE_ENABLED_DOMAIN_WHITELIST);

	public static final String[] USER_DETAILS_UPDATE_ENABLED_ROLE_WHITELIST = PropsUtil.getArray(PropsKeys.USER_DETAILS_UPDATE_ENABLED_ROLE_WHITELIST);
